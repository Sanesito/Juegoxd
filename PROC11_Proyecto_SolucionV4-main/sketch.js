...
function setup(){
  ...
  pista = createSprite(400,400,600,1000);
  pista.addImage(pistaImg);
  pista.velocityX = -3
  pista.scale = 10


  carro = createSprite(30,400,50,50);
  ...
  boton = createSprite(600,550,50,50)
...
function obstacles () {
  if(frameCount %100 === 0){
  obstacles1 = createSprite(1300,200,50,50);
...
function recompenzas () {
  if(frameCount %150 === 0){
  recompenza = createSprite(1300,250,50,50);
